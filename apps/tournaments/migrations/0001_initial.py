    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player1_team1', models.CharField(blank=True, max_length=100, verbose_name='Player 1 (Team 1)')),
                ('player2_team1', models.CharField(blank=True, max_length=100, verbose_name='Player 2 (Team 1)')),
                ('player1_team2', models.CharField(blank=True, max_length=100, verbose_name='Player 1 (Team 2)')),
                ('player2_team2', models.CharField(blank=True, max_length=100, verbose_name='Player 2 (Team 2)')),
